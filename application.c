...
const ModeInfo modeInfo[] = {
    ...
    [CONDUCTOR] = {
        ...
        "Number test and tone generator\n"
        "[num]e - Show 3-history sum/median\n"
        "F - Clear history\n"
        "[num]K - Brother John periods\n"
        "g - Generate 1kHz tone\n"
        "[num]v - Set volume\n"
        "m - Toggle mute\n"
        "D - Toggle deadlines\n"
        "Background Load:\n"
        "l - Start background load\n"
        "s - Stop background load\n"
        "i - Increase load\n"
        "d - Decrease load\n"
        "WCET Calculate:\n"
        "t - Tone generator WCET\n"
        "y - Load WCET\n"
        "Music Player:\n"
        "p - Play music\n"
        "k - Change key\n"
    ...
    [MUSICIAN] = {
        ...
        "Turn to Conductor mode for keyboard user guide\n"
    }
};
